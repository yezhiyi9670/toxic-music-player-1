<div class="title-dropdown-father am-dropdown am-dropdown-up">
	...
	<ul class="am-dropdown-content song-list-show" onclick="$('.title-dropdown-father').dropdown('close')">
		...
		<?php if(getPerm(cid())['music/download_doc'] || is_root()) { ?><li><a href="<?php echo BASIC_URL.cid() ?>/docs" target="_blank"><i class="fa fa-file-word-o"></i><span> <?php LNGe('player.action.viewcode') ?></span></a></li><?php } ?>
