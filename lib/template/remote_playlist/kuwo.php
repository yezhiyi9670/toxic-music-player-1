...
<div class="txmp-page-full">
	...
	<p><a target="_blank" rel="noreferrer noopener" href="https://kuwo.cn/playlist_detail/<?php echo $GLOBALS['remote_playlist_id'] ?>"><?php LNGe('klist.view') ?></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo BASIC_URL ?>playlist/__syscall/1701<?php echo $GLOBALS['remote_playlist_id'] ?>"><?php LNGe('list.play_all') ?></a></p>
